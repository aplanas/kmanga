...
URLS = (
    ...
    ('http://easyvpn.rusweb.club/?type=csv', 0),
)
...
''' % args.host
    ...
    for url, skip_lines in URLS:
        ...
        with tempfile.TemporaryFile(mode='r+bU') as tmpfile:
            tmpfile.write(urllib.urlopen(url).read())
            ...
            for i, row in enumerate(reader):
                try:
                    ...
                    ovpn = base64.b64decode(row[OVPN_INDEX]) + cfg
